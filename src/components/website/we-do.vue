    ...
    <div class="bg-white container-fluid">
        <div class="container">
            ...
            <div class="col-12 Img">
                <img src="/src/assets/img/fastestFood.png" />
            </div>
            ...
            <div class="col-12 Img mb-5">
                <img src="/src/assets/img/controlImg.png" />
            </div>
            <div class="py-5">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">We watch the clock</h5>
                                <p class="card-text">Wherever you are in the world, you’ll feel like we’re right around the corner. With 10 years of experience, our business processes are seamless and time differences don’t matter.</p>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Contemporary approach</h5>
...
<script>
import Project from '@/components/all_project/project.vue'
export default{
    components: {
