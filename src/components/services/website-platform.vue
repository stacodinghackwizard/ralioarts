    ...
    <div class="container-fluid hero-header background py-5">
        <div class="container">
            <div class="col-12 pb-5 text-center">
                <h1 class="mb-3 animated slideInDown brand-text px-0"><span class="black">Websites and <br/> platsform </span></h1>
            </div>
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 animated fadeIn  brandImg">
                    <div class="brandImgPosition">
                        <div class="brandImg1">
                            ...
                            <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;" src="/src//assets//img/serviceImg1.png"
                                alt="">
                        </div>
                ...
                <div class="col-lg-6 pl-md-5">
                    <div class="pl-md-5">
                        ...
                        <h6 class="mb-3 animated slideInDown  brand-text px-0">Website and platsform </h6>
